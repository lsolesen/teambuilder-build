...
function teambuilder_vih_dk_profile_modules() {
  return array(
    ...
    // contrib
    'addthis', 'admin_menu', 'addthis', 'comment_notify', 'content_access', 'contextual', 'imagecache', 'imagecache_ui', 'imce', 'imce_wysiwyg', 'libraries', 'pathauto', 'vertical_tabs', 'wysiwyg'
  );
}
