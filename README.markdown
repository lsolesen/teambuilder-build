[teambuilder.vih.dk](http://teambuilder.vih.dk) [![Build Status](https://secure.travis-ci.org/lsolesen/teambuilder.vih.dk.png?branch=6.x-1.x)](http://travis-ci.org/lsolesen/teambuilder.vih.dk)
==
